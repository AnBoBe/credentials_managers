...
export default function createMicrosoftRouter() {
  ...
  // Leer variables de entorno aquí, dentro de la función
  ...
  router.get("/login", (req, res) => {
    const url = `${authorizeUrl}?client_id=${clientId}&response_type=code&redirect_uri=${encodeURIComponent(
      redirectUri
    )}&response_mode=query&scope=openid profile email User.Read&state=12345`;
